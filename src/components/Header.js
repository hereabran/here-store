                    ...
                    <ul class="nav__menu">
                        {_.map(_.get(this.props, 'pageContext.menus.main'), (item, item_idx) => {
                            ...
                            return (<React.Fragment key={item_idx}>
                                <li key={item_idx} class="nav__menu-item">
                    ...
                    <div class="nav__right">
                        ...
                        <div class="hamburger__content hamburger__content--closed">
                            <div class="hamburger__options">
                                ...
                                <div class="">
                                    <span class="snipcart-items-count" /> products | <span class="snipcart-total-price" />                        </div>
                                </div>
                            ...
                            <ul class="hamburger__nav">
                                {_.map(_.get(this.props, 'pageContext.menus.main'), (item, item_idx) => {
                                    ...
                                    let isActive = (_.get(item, 'title') === section) ? true : false;
                                    return (<React.Fragment key={item_idx}>
                                        <li key={item_idx} class="hamburger__nav-item">
